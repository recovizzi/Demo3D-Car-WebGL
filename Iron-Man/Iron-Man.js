...
function render() {
	...
	if(ntextures_tobeloaded == ntextures_loaded){
		...
		modelview = mult(modelview, translate(0.0, -25.0, 0.0));
		...
		// // assign "0" to renderingoption in fragment shader (no texture, only Phong model)
		...
		// //assign "1" to renderingoption in fragment shader (texture only and no Phong model)
...
var onresize = function(e) {
 // détermine la surface restante pour le canvas en soustrayant les bordures (à gauche et en haut)
  var actualPanelWidth = Math.floor(window.innerWidth - 110); 
