...
function cube(side) {
 ...
 /**
  * Create a model of a prisme, centered at the origin.  
  * @side the length of a side of the prisme.  If not given, the value will be 1.
  */
  function prisme(side) {
   var s = (side || 1)/2;
   var coords = [];
   var normals = [];
   var texCoords = [];
   ...
   function face(xyz, nrm) {
      ...
      // texCoords.push(0,0,1,0,1,1,0,1);
      if(nbface == 5){
         texCoords.push(0,0,0.5,0,0.5,0.5,0,0.5);
      }else{
         texCoords.push(0,0.5,0.5,0.5,0.5,1,0,1);
      }
...
/**
  ...
  * @side the length of a side of the prisme.  If not given, the value will be 1.
  */
 function customface(point1,point2,point3,point4) {
   // var s = (side || 1)/2;

   var t1 = subtract(point2, point1);
   var t2 = subtract(point3, point1);
   var normal = cross(t2, t1);
   var normal = vec3(normal);   
   // console.log("t1 = "+t1+" t2 = "+t2+" normal = "+normal);
   ...
   // face( [-s,-s,s, s,-s,s, s,s,s, -s,s,s], [0,0,1] );
   face( [point1[0],point1[1],point1[2],point2[0],point2[1],point2[2],point3[0],point3[1],point3[2],point4[0],point4[1],point4[2]], [normal[0],normal[1],normal[2]] );
   face( [point1[0],point1[1],-point1[2],point2[0],point2[1],-point2[2],point3[0],point3[1],-point3[2],point4[0],point4[1],-point4[2]], [normal[0],normal[1],-normal[2]] );
